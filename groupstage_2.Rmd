---
title: "EURO 2024 groupstage predictions: 2nd match day"
...
# Groupstage predictions: 2nd match day (19-22 June)
...
```{r groupstage2, echo = FALSE, out.width="80%", fig.width=11, eval = TRUE, fig.height=16,warning=FALSE, message=FALSE}
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Libraries 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
library(tidyverse)
...
euro_data_stan <-rbind(euro_data_train, results_groupstage_1,euro_data_test)
...
write.csv(prob$prob_table, paste0(TABLES_PATH,"groupstage_2.csv"), row.names = FALSE)
prob$prob_plot
```
