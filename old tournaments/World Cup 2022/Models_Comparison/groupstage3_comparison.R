...
## dynamic models----------
n_iter <- 2000
fit_diag_infl_biv_pois_matchday3 <- stan_foot(data = wc_data_stan[,-6],
...
save(fit_diag_infl_biv_pois_matchday3,file="fit_diag_infl_biv_pois_matchday3")


fit_biv_pois_matchday3 <- stan_foot(data = wc_data_stan[,-6],
                          model="biv_pois",
                          iter = n_iter,cores = 2, chains=2, 
                          predict=  ngames_matchday3,
                          ranking = wc_ranking,
                          dynamic_type = "seasonal",
                          ind_home = "FALSE") # diag. inflated biv pois
save(fit_biv_pois_matchday3,file="fit_biv_pois_matchday3")



fit_double_pois_matchday3 <- stan_foot(data = wc_data_stan[,-6],
                             model="double_pois",
                             iter = n_iter, cores = 2, chains=2,
                             predict= ngames_matchday3,
                             ranking = wc_ranking,
...
save(fit_double_pois_matchday3,file="fit_double_pois_matchday3")
...
# Loo measures
loo_fit_diag_infl_biv_pois<-loo(fit_diag_infl_biv_pois_matchday3)# 22398.2 170.1
loo_fit_biv_pois<-loo(fit_biv_pois_matchday3)#18105.2 119.9
loo_fit_double_pois<-loo(fit_double_pois_matchday3)# 18100.6 121.3

loo_compare(loo_fit_diag_infl_biv_pois_matchday3,
            loo_fit_biv_pois_matchday3,
            loo_fit_double_pois_matchday3 )
