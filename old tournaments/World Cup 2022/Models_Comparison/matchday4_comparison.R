...
n_iter <- 2000
fit_diag_infl_biv_pois_matchday4 <- stan_foot(data = wc_data_stan[,-6],
...
save(fit_diag_infl_biv_pois_matchday4,file="fit_diag_infl_biv_pois_matchday4")


fit_biv_pois_matchday4 <- stan_foot(data = wc_data_stan[,-6],
                                    model="biv_pois",
                                    iter = n_iter,cores = 2, chains=2, 
                                    predict=  ngames_matchday4,
                                    ranking = wc_ranking,
                                    dynamic_type = "seasonal",
                                    ind_home = "FALSE") # diag. inflated biv pois
save(fit_biv_pois_matchday4,file="fit_biv_pois_matchday4")



fit_double_pois_matchday4 <- stan_foot(data = wc_data_stan[,-6],
                                       model="double_pois",
                                       iter = n_iter, cores = 2, chains=2,
                                       predict= ngames_matchday4,
                                       ranking = wc_ranking,
...
save(fit_double_pois_matchday4,file="fit_double_pois_matchday4")
...
# Loo measures
loo_fit_diag_infl_biv_pois<-loo(fit_diag_infl_biv_pois_matchday4)# 22398.2 170.1
loo_fit_biv_pois<-loo(fit_biv_pois_matchday4)#18105.2 119.9
loo_fit_double_pois<-loo(fit_double_pois_matchday4)# 18100.6 121.3

loo_compare(loo_fit_diag_infl_biv_pois_matchday4,
            loo_fit_biv_pois_matchday4,
            loo_fit_double_pois_matchday4)
