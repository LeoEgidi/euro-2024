---
title: "World Cup Qatar 2022 predictions: finals"
...
# Finals predictions (17-18 December)
...
wc_data_test <- data.frame(
  ...
  home_score = rep(NA, ngames_matchday7),
  away_score = rep(NA, ngames_matchday7),
  tournament = rep(NA, ngames_matchday7))
