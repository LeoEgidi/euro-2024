---
title: "EURO 2024 knockout predictions: round of 16"
...
# Knockout predictions: round of 16 (29th June - 02th July)
...
```{r round_of_16, echo = FALSE, out.width="80%", fig.width=11, eval = TRUE, fig.height=16,warning=FALSE, message=FALSE}
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Libraries 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
library(tidyverse)
...
write.csv(prob$prob_table, paste0(TABLES_PATH,"round_of_16.csv"), row.names = FALSE)
prob$prob_plot
```
