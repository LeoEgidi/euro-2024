---
title: "EURO 2024 knockout predictions: Quarter-final"
...
# Knockout predictions: Quarter-final (05th July - 06th July)
...
```{r quarter-final, echo = FALSE, out.width="80%", fig.width=11, eval = TRUE, fig.height=16,warning=FALSE, message=FALSE}
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Libraries 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
library(tidyverse)
...
fit <- stan_foot(data = euro_data_stan[,-6],
                 ...
                 ind_home = "FALSE")
pars=extract(fit)
save(pars, file = paste0(MODELS_PATH,"quarter-final_pars.RData"))
...
write.csv(prob$prob_table, paste0(TABLES_PATH,"quarter-final.csv"), row.names = FALSE)
prob$prob_plot
```
